...
def get_foreground_mask(image, smoothing=2):
    """
    Get the foreground mask for an image
    ...
    _, mask = cv.threshold(image, 110, 255,
                           cv.THRESH_BINARY)  # 110 is the threshold value the higher the value the less is removed
